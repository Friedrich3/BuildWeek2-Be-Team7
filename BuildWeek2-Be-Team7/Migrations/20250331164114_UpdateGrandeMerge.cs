        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Products_Drawers_IdDrawer",
                        column: x => x.IdDrawer,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_IdPharmacist",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HospitalizationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalExams", x => x.ExamId);
                    table.ForeignKey(
                        name: "FK_MedicalExams_AspNetUsers_VetId",
                        column: x => x.VetId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicalExams_Pets_PetId",
                        column: x => x.PetId,
                        principalTable: "Pets",
                        principalColumn: "PetId");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "91745C18-A978-4202-81D9-BDAC8CB5E2F0", "91745C18-A978-4202-81D9-BDAC8CB5E2F0", "Farmacista", "FARMACISTA" },
                    { "B0B023D5-5C9A-430F-B38F-53D8781BAEA9", "B0B023D5-5C9A-430F-B38F-53D8781BAEA9", "Veterinario", "VETERINARIO" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Alta rotazione", "Center left" },
                    { 2, "Emergenza", "Top left" },
                    { 3, "Uso Comune", "Center right" },
                    { 4, "Specialistici", "Bottom left" },
                    { 5, "Refrigerati", "Bottom right" },
                    { 6, "Nutraceutici", "Top right" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalExams_PetId",
                table: "MedicalExams",
                column: "PetId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalExams_VetId",
                table: "MedicalExams",
                column: "VetId");
